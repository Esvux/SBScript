...
public class ParserSBScript implements ParserSBScriptConstants {
  ...
  para realizar el análisis sintáctico (2 para diferenciar entre
  ...
  -----------------------------------------------------------*/
    ...
    CUERPO -> "{" ( SENTENCIA )* "}"
  _____________________________________________________________
  Esta producción agrupa las sentencias, delimitadas por un juego
  de llaves, en un nodo de tipo CUERPO.
               ____________
              | CUERPO     |
              |____________|
                 |     ______________
  ...
  -----------------------------------------------------------*/
    final public Nodo LOG_OR() throws ParseException {
        ...
        ;
            ...
            nodo = FabricaAST.creaLogica(Constantes.OP_OR, temp, extra);
        }
        {
            if (true) {
                return nodo;
  ...
  -----------------------------------------------------------*/
    final public Nodo LOG_AND() throws ParseException {
        ...
        ;
            ...
            extra = LOG_XOR();
            temp = FabricaAST.copiar(nodo);
            nodo = FabricaAST.creaLogica(Constantes.OP_AND, temp, extra);
        }
        {
            if (true) {
                return nodo;
  ...
  -----------------------------------------------------------*/
    final public Nodo LOG_XOR() throws ParseException {
        ...
        ;
            ...
            extra = LOG_NOT();
            temp = FabricaAST.copiar(nodo);
            nodo = FabricaAST.creaLogica(Constantes.OP_XOR, temp, extra);
        }
        {
            if (true) {
                return nodo;
    ...
    final public Nodo RELACIONAL() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case 17:
                ...
                extra = ARITM();
                temp = FabricaAST.copiar(nodo);
                nodo = FabricaAST.creaRelacional(op, temp, extra);
                break;
            default:
                jj_la1[23] = jj_gen;
                ;
  ...
  de tipo relacional.
  -----------------------------------------------------------*/
    final public String OP_REL() throws ParseException {
        String op;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case 12:
                jj_consume_token(12);
        ...
        ;
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case 18:
                    ...
                    extra = TERM();
                    temp = FabricaAST.copiar(nodo);
                    nodo = FabricaAST.creaAritmetica(Constantes.OP_SUM, temp, extra);
                    break;
                case 19:
                    jj_consume_token(19);
                    extra = TERM();
                    temp = FabricaAST.copiar(nodo);
                    nodo = FabricaAST.creaAritmetica(Constantes.OP_RES, temp, extra);
                    break;
                default:
                    jj_la1[26] = jj_gen;
                    jj_consume_token(-1);
        ...
        ;
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case 20:
                    ...
                    extra = FACT();
                    temp = FabricaAST.copiar(nodo);
                    nodo = FabricaAST.creaAritmetica(Constantes.OP_MUL, temp, extra);
                    break;
                case 21:
                    jj_consume_token(21);
                    extra = FACT();
                    temp = FabricaAST.copiar(nodo);
                    nodo = FabricaAST.creaAritmetica(Constantes.OP_DIV, temp, extra);
                    break;
                case 22:
                    jj_consume_token(22);
                    extra = FACT();
                    temp = FabricaAST.copiar(nodo);
                    nodo = FabricaAST.creaAritmetica(Constantes.OP_MOD, temp, extra);
                    break;
                default:
                    jj_la1[28] = jj_gen;
                    jj_consume_token(-1);
  ...
  -----------------------------------------------------------*/
    final public Nodo FACT() throws ParseException {
        ...
        ;
            ...
            extra = VAL();
            temp = FabricaAST.copiar(nodo);
            nodo = FabricaAST.creaAritmetica(Constantes.OP_POT, temp, extra);
        }
        {
            if (true) {
                return nodo;
